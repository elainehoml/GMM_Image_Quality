...
def summary_plots():
    ...
    def poster_linreg_plots():
        ...
        # plt.xlim([0,150])
        # plt.ylim([0,150])
        sns.regplot(xvals_flat, conv_flat, label = r"Conventional, $R^2$ = {0:.3f}".format(conv_linreg_r2), color = 'r', marker = ".", scatter_kws= {'facecolors':'none'}, line_kws = {'linewidth':1.5})
        sns.regplot(xvals_flat, GMM_flat, label = r"GMM, $R^2$ = {0:.3f}".format(GMM_linreg_r2), marker = ".", scatter_kws= {'facecolors':'none'}, line_kws = {'linewidth':1.5})
